...
const ServicesSection = () => {
  ...
  useEffect(() => {
    fetch("/data/services.json")
      .then((res) => res.json())
      .then((data) => {
        // ✅ merge JSON with fallback (keep id)
    ...
    <div className="bg-white py-16 px-4 font-sans text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="text-sm font-bold text-gray-600 bg-gray-200 px-3 py-1 rounded-full w-fit mx-auto mb-4 inline-block">
            <span className="bg-gradient-to-br from-[#792F6C] to-[#E2335F] bg-clip-text text-transparent">
              Our Services
            </span>
          </span>

          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-2 leading-tight">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            We create digital solutions that help businesses grow. From software
            to apps and web platforms, our services deliver real impact.
          </p>
        </motion.div>
