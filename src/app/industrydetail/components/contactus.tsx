      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-4 text-xl text-gray-500 max-w-2xl">
            Have questions, ideas, or a project you'd like to discuss? We'd love to hear from you. At Eagale Soft, we're always ready to help businesses grow with innovative digital solutions.
          </p>
        </div>
      </div>
